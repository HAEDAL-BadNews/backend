create database BadnewsDB;
use BadnewsDB
create table article (article_date datetime, now date, scrap bit not null, id bigint not null, image_id bigint, author varchar(255), category varchar(255), context varchar(255), title varchar(255), url varchar(255), user_id varchar(255), primary key (id)) engine=InnoDB
